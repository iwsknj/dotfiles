...
-- タブ
keymap.set("n", "te", ":tabedit") -- 開く
keymap.set("n", "<tab>", ":tabnext<Return>", opts) -- 次のタブ
keymap.set("n", "<s-tab>", ":tabprev<Return>", opts) -- 前のタブ

-- 画面分割
keymap.set("n", "ss", ":split<Return>", opts) -- 水平分割
keymap.set("n", "sv", ":vsplit<Return>", opts) -- 垂直分割

-- 画面移動
keymap.set("n", "sh", "<C-w>h") -- 左
keymap.set("n", "sk", "<C-w>k") -- 上
keymap.set("n", "sj", "<C-w>j") -- 下
keymap.set("n", "sl", "<C-w>l") -- 右
